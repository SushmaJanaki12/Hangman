...
#taking a random word from a file
def randomWord():
    file = open("D:\Hangman\words.txt")
    f = file.readlines()
    i = random.randrange(0, len(f) - 1)

    return f[i][:-1]

#checking whether guessed letter is in the word or not
def hang(guess):
    global word
...
#defining blanks at bottom of the screen
...
hangmanPics=[]
for i in range(7):
    hangmanPic= pygame.image.load("D:/Hangman/"+"hangman"+str(i)+".png")
